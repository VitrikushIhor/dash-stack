    ...
    <DndProviderWrapper tasks={tasks} onTaskUpdate={handleTaskUpdate}>
      {(optimisticTasks) => (
        <div className='flex flex-col gap-4'>
          <CalendarHeader tasks={optimisticTasks} view='month' selectedDate={selectedDate} setParams={setParams} />
          <CalendarMonthView singleDayTasks={optimisticTasks} selectedDate={selectedDate} setParams={setParams} />
        </div>
      )}
    </DndProviderWrapper>
  )
