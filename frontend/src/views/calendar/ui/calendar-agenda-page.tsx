    ...
    <DndProviderWrapper tasks={tasks} onTaskUpdate={handleTaskUpdate}>
      {(optimisticTasks) => (
        <div className='flex flex-col gap-4'>
          <CalendarHeader tasks={optimisticTasks} view='agenda' selectedDate={selectedDate} setParams={setParams} />
          <CalendarAgendaView tasks={optimisticTasks} selectedDate={selectedDate} setParams={setParams} />
        </div>
      )}
    </DndProviderWrapper>
  )
